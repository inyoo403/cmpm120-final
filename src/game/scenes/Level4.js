...
export default class Level4 extends BaseScene {
    ...
    preload() {
        ...
        // 보스 관련 사운드 로드
        this.load.audio('bossdeath', 'assets/bossdeath.ogg');
        this.load.audio('bosswalk', 'assets/bosswalk.ogg');
    }
    ...
    handleBossDefeat() {
        ...
        // 보스 사망 사운드 재생
        this.sound.play('bossDeathSound', { volume: 0.5 });
            ...
            if (distance <= 64) {
                ...
                if (this.boss.body.onFloor()) {
                    ...
                    if (currentTime - this.lastBossWalkSoundTime > this.bossWalkSoundCooldown) {
                        this.sound.play('bosswalk', { volume: 0.3 });
