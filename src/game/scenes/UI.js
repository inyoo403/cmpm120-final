...
export default class UI extends Scene {
    ...
    showCenterMessage(message, duration = 2000) {
        if (this.centerMessage) {
            ...
            if (this.centerMessageBg) {
                this.centerMessageBg.destroy();
            }
        }
        ...
        // 배경 추가
        this.centerMessageBg = this.add.rectangle(
            centerX,
            centerY,
            400,
            100,
        ...
        // 메시지 텍스트
        this.centerMessage = this.add.text(centerX, centerY, message, {
            fontFamily: 'Arial Black',
            fontSize: '32px',
            fill: '#ff0000',
            stroke: '#000000',
